...
export const ProductLaunchTabs = (props: any) => {
    ...
    const { formState, handleInputChange, handleFormChange, ...restProps } = props;
    
    // Create props for sub-components (minimal form state needed)
    ...
    return (
        <Tabs value={props.productLaunchSubTab} onValueChange={props.setProductLaunchSubTab} className="w-full">
            ...
            <TabsContent value="brief-creation">
                <BriefCreationTab {...briefCreationTabProps} />
            </TabsContent>
                        ...
                        {props.products && Object.keys(props.products).length > 0 && (
                            <div>
                                <ProductSelection
                                    ...
                                    description="Select products to include in your product launch brief. You can feature multiple products in a single campaign."
                                />
                            </div>
                        )}
                    </CardContent>
