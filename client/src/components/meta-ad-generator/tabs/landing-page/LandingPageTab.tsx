...
import { FileText, List, Target, Sparkles, Settings, Globe, Check, Copy, Zap } from 'lucide-react';
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                      <div className="text-center lg:text-left">
                        ...
                        {(isProductFramework ? (productFramework?.hero_section?.cta_button || productFramework?.final_cta?.cta_button) : generatedLandingCopy.cta) && (
                          <div className="mt-6">
                            <Button className="text-white px-6 py-2 text-sm sm:text-base" style={{ backgroundColor: '#004182' }}>
                              {isProductFramework ? (productFramework?.hero_section?.cta_button || productFramework?.final_cta?.cta_button) : generatedLandingCopy.cta}
                            </Button>
                          </div>
                        )}
