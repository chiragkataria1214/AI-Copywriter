...
import ProtectedPromptEditor from '@/components/main/ai-settings/common/ProtectedPromptEditor';
...
import { VariableEditor } from '@/components/main/ai-settings/editors/VariableEditor';
