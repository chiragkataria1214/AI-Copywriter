...
import { Sparkles, Trash2, ChevronDown, ChevronRight, Plus, Mail, Upload, X, List, MessageSquare } from 'lucide-react';
...
interface CopyFrameworksTabProps {
  ...
  setEditingConfig: (config: TrainingConfig | ((prevState: TrainingConfig) => TrainingConfig)) => void;
  effectiveUser: any;
...
export const CopyFrameworksTab: React.FC<CopyFrameworksTabProps> = ({
  ...
  useEffect(() => {
    const loadAllFrameworks = async () => {
      console.log('DEBUG: Loading all frameworks from API...');
      setLoadingEmailFrameworks(true);
      setLoadingSmsFrameworks(true);
      setLoadingLandingPageFrameworks(true);
      
      try {
        const [emailResponse, landingPageResponse, smsResponse] = await Promise.all([
          apiRequest('/api/email-frameworks').catch(e => { console.error('Failed to load email frameworks', e); return null; }),
          apiRequest('/api/landing-page-frameworks').catch(e => { console.error('Failed to load landing page frameworks', e); return null; }),
          apiRequest('/api/sms-frameworks').catch(e => { console.error('Failed to load sms frameworks', e); return null; })
        ]);

        console.log('DEBUG: Received all framework responses from API');

        const emailFrameworks = (emailResponse || []).map((framework: any) => ({
          ...framework,
          isEnabled: framework.isActive === 'true' || framework.isActive === true
        }));
        
        const landingPageFrameworks = (landingPageResponse || []).map((framework: any) => ({
          ...framework,
          isEnabled: framework.isActive === 'true' || framework.isActive === true
        }));

        const smsFrameworks = (smsResponse || []).map((framework: any) => ({
          ...framework,
          isEnabled: framework.isActive === 'true' || framework.isActive === true
        }));

        const newConfig = { ...editingConfig };
        const prevFrameworks = {
            emailFrameworks: newConfig.copyFrameworks?.emailFrameworks || [],
            landingPageFrameworks: newConfig.copyFrameworks?.landingPageFrameworks || [],
            smsFrameworks: newConfig.copyFrameworks?.smsFrameworks || [],
        };
        const newFrameworks = {
            emailFrameworks,
        ...
        if (JSON.stringify(prevFrameworks) !== JSON.stringify(newFrameworks)) {
            newConfig.copyFrameworks = {
                ...newConfig.copyFrameworks,
                ...newFrameworks,
            };
        ...
        console.log('DEBUG: Updated config with all frameworks');
        
      } catch (error) {
        console.error('Failed to load frameworks:', error);
        toast({
          title: "Error",
          description: "Failed to load frameworks from database. Some sections may be incomplete.",
          variant: "destructive",
        });
      } finally {
    ...
    if (frameworksLoadedRef.current) return;
    frameworksLoadedRef.current = true;
    loadAllFrameworks();
  }, [setEditingConfig, toast]); // Only run once on mount
        ...
        {effectiveUser?.role === 'admin' && title === 'Meta Ads Frameworks' && (
          <Button
            onClick={(e) => {
              ...
              setEditingConfig((prevConfig: TrainingConfig) => ({
                ...prevConfig,
                copyFrameworks: {
                  ...prevConfig.copyFrameworks,
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              const { value } = e.target;
                              const updated = [...(editingConfig.copyFrameworks?.headlineFrameworks || [])];
                              updated[index] = { ...updated[index], template: value };
                              setEditingConfig((prevConfig: TrainingConfig) => ({
                                ...prevConfig,
                                copyFrameworks: {
                                  ...prevConfig.copyFrameworks,
                          ...
                          <div className="mt-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e) => {
                                ...
                                const { value } = e.target;
                                const updated = [...(editingConfig.copyFrameworks?.emailFrameworks || [])];
                                updated[index] = { ...updated[index], structure: value };
                                setEditingConfig((prevConfig: TrainingConfig) => ({
                                  ...prevConfig,
                                  copyFrameworks: {
                                    ...prevConfig.copyFrameworks,
                          ...
                          <div className="mt-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e) => {
                                ...
                                const { value } = e.target;
                                const updated = [...(editingConfig.copyFrameworks?.emailFrameworks || [])];
                                updated[index] = { ...updated[index], keyElements: value };
                                setEditingConfig((prevConfig: TrainingConfig) => ({
                                  ...prevConfig,
                                  copyFrameworks: {
                                    ...prevConfig.copyFrameworks,
                          ...
                          <div className="mt-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e) => {
                                ...
                                const { value } = e.target;
                                const updated = [...(editingConfig.copyFrameworks?.emailFrameworks || [])];
                                updated[index] = { ...updated[index], frameworkContent: value };
                                setEditingConfig((prevConfig: TrainingConfig) => ({
                                  ...prevConfig,
                                  copyFrameworks: {
                                    ...prevConfig.copyFrameworks,
                          ...
                          <div className="mt-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e) => {
                                ...
                                const { value } = e.target;
                                const updated = [...(editingConfig.copyFrameworks?.emailFrameworks || [])];
                                updated[index] = { ...updated[index], systemPrompt: value };
                                setEditingConfig((prevConfig: TrainingConfig) => ({
                                  ...prevConfig,
                                  copyFrameworks: {
                                    ...prevConfig.copyFrameworks,
                          ...
                          <div className="mt-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e) => {
                                ...
                                const { value } = e.target;
                                const updated = [...(editingConfig.copyFrameworks?.emailFrameworks || [])];
                                updated[index] = { ...updated[index], outputRequirements: value };
                                setEditingConfig((prevConfig: TrainingConfig) => ({
                                  ...prevConfig,
                                  copyFrameworks: {
                                    ...prevConfig.copyFrameworks,
                          ...
                          <div className="mt-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                const { value } = e.target;
                                const updated = [...(editingConfig.copyFrameworks?.emailFrameworks || [])];
                                updated[index] = { ...updated[index], expectedLength: value };
                                setEditingConfig((prevConfig: TrainingConfig) => ({
                                  ...prevConfig,
                                  copyFrameworks: {
                                    ...prevConfig.copyFrameworks,
                  ...
                  onChange={(e) => {
                    ...
                    setEditingConfig((prevConfig: TrainingConfig) => ({
                      ...
                      copyFrameworks: {
                        ...prevConfig.copyFrameworks,
                        brandDrBalance: {
                          ...prevConfig.copyFrameworks?.brandDrBalance,
                ...
                onClick={() => {
                  setEditingConfig((prevConfig: TrainingConfig) => ({
                    ...
                    copyFrameworks: {
                      ...
                      brandDrBalance: {
                        ...prevConfig.copyFrameworks?.brandDrBalance,
                        brandFirst: [...(prevConfig.copyFrameworks?.brandDrBalance?.brandFirst || []), '']
                      }
                    }
                  }));
                }}
                ...
                onClick={() => {
                  setEditingConfig((prevConfig: TrainingConfig) => ({
                    ...
                    copyFrameworks: {
                      ...
                      brandDrBalance: {
                        ...prevConfig.copyFrameworks?.brandDrBalance,
                        directResponse: [...(prevConfig.copyFrameworks?.brandDrBalance?.directResponse || []), '']
                      }
                    }
                  }));
                }}
