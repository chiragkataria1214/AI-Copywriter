...
interface AISettingsComponentProps {
  ...
  setEditingConfig: React.Dispatch<React.SetStateAction<TrainingConfig | null>>;
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="brand-guidelines" className="mt-4">
                  <BrandGuidelinesTab
                    ...
                    onSaveBrandGuidelines={(bg) => callMutateAsync(saveBrandGuidelinesMutation, bg)}
                  />
                </TabsContent>
                ...
                <TabsContent value="frameworks" className="mt-4">
                  <CopyFrameworksTab
                    editingConfig={editingConfig}
                    setEditingConfig={setEditingConfig as React.Dispatch<React.SetStateAction<TrainingConfig>>}
                    effectiveUser={effectiveUser}
