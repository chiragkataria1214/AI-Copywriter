                                                        ...
                                                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2">
                                                            ...
                                                            <TooltipProvider>
                                                                <Tooltip>
                                                                    ...
                                                                    <TooltipContent>
                                                                        {copiedStates['analysis'] ? 'Copied' : 'Copy'}
                                                                    </TooltipContent>
                                                                </Tooltip>
                                                            </TooltipProvider>
                                                        ...
                                                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2">
                                                          <TooltipProvider>
                                                            <Tooltip>
                                                              ...
                                                              <TooltipContent>
                                                                {copiedStates['all-variations'] ? 'Copied' : 'Copy All'}
                                                              </TooltipContent>
                                                            </Tooltip>
                                                          </TooltipProvider>
                                                        </div>
                                                        ...
                                                        <Tooltip>
                                                            <TooltipTrigger asChild>
                                                                <Button
                                                                    variant="outline"
                                                                    size="icon"
                                                                    onClick={() => handleCopyToClipboard(staticAdAnalysis, 'static-ad-analysis')}
                                                                    className="w-full sm:w-auto"
                                                                    disabled={copiedStates['static-ad-analysis']}
                                                                >
                                                                    {copiedStates['static-ad-analysis'] ? <Check size={16} /> : <Copy size={16} />}
                                                                </Button>
                                                            </TooltipTrigger>
                                                            <TooltipContent>
                                                                {copiedStates['static-ad-analysis'] ? 'Copied' : 'Copy'}
                                                            </TooltipContent>
                                                        </Tooltip>
                                                    </TooltipProvider>
                                                    <StandardizedDebugButton
