...
import { AdCopyTab } from '@/components/main/tabs/paid-social/AdCopyTab';
import { StaticAdTab } from '@/components/main/tabs/paid-social/StaticAdTab';
...
export const PaidSocialTabs = (props: any) => {
    ...
    const adCopyTabProps = createTabProps(formState, handleInputChange, {
        ...
        testingFocus: adCopyGeneration?.testingFocus,
        strategicInsights: adCopyGeneration?.strategicInsights,
